  ...
  return (
    <div className="max-w-3xl mx-auto p-8">
      ...
      <section className="mb-6">
        ...
        <p>If you have any questions or concerns about this privacy policy or your data, you can contact us at: <a href="mailto:astrospectrum@astrospectrum.uz" className="text-blue-500 underline">support@astrospectrum.uz</a></p>
      </section>
    </div>
  );
}
